  ...
  return (
    <div className="pt-40 bg-white relative overflow-hidden animate-fade-in">
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        <div className="mb-16">
          <h1 className="text-[3.5rem] md:text-[5rem] font-bold text-[#333] mb-4">{t.title}</h1>
          <p className="text-[1.125rem] text-gray-400 max-w-3xl">{t.description}</p>
        </div>
        <div className="grid lg:grid-cols-12 gap-16 mb-24">
          <div className="lg:col-span-4 space-y-12">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h3 className="text-sm font-bold tracking-widest text-gray-800 mb-2">{t.emailLabel}</h3>
                <p className="text-gray-500">exports@velveproduce.com</p>
              </div>
            </div>
            <div className="flex items-center gap-6">
              ...
              <div>
                <h3 className="text-sm font-bold tracking-widest text-gray-800 mb-2">{t.callLabel}</h3>
                <p className="text-gray-500">+34 618 07 75 68</p>
              </div>
            </div>
          </div>
          <div className="lg:col-span-8">
            <div className="bg-white rounded-[4rem] p-8 md:p-12 shadow-2xl border border-gray-50">
              {formStatus === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <input required name="user_name" type="text" placeholder={t.form.name} className="w-full px-8 py-6 bg-[#F8F9FD] border-none rounded-[1.5rem] focus:ring-2 focus:ring-[#26C29E]" />
                  <input required name="user_email" type="email" placeholder={t.form.email} className="w-full px-8 py-6 bg-[#F8F9FD] border-none rounded-[1.5rem] focus:ring-2 focus:ring-[#26C29E]" />
                  <textarea required name="message" rows={6} placeholder={t.form.message} className="w-full px-8 py-6 bg-[#F8F9FD] border-none rounded-[1.5rem] focus:ring-2 focus:ring-[#26C29E] resize-none"></textarea>
                  <button type="submit" disabled={formStatus === 'sending'} className="bg-[#26C29E] text-white px-12 py-5 rounded-full font-bold shadow-xl flex items-center gap-3">
      ...
      <section id="home" className="min-h-screen hero-gradient flex items-center pt-20">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2">
            ...
            <p className="text-[1.125rem] text-gray-600 mb-8 max-w-lg">{t.hero.subtitle}</p>
            <div className="flex gap-4">
              <a href="#products" onClick={(e) => { e.preventDefault(); document.getElementById('products')?.scrollIntoView({ behavior: 'smooth' }); }} className="bg-[#464196] text-white px-8 py-4 rounded-full font-bold shadow-lg flex items-center gap-2">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="md:w-1/2">
              ...
              <p className="text-gray-600 mb-8">{t.history.text}</p>
              <button 
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {t.services.items.map((item, idx) => (
              <div key={idx} className="bg-white/80 p-8 rounded-[2rem] border border-blue-50 shadow-sm hover:shadow-xl transition-all">
